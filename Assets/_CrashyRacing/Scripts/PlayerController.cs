...
public class PlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //My  
        //Debug.Log("PlayerController_Start = "+GameManager.Instance.GameState);
	...
	// my code
	public void SwitcherCorutineIncreaseSpeed()
	{
	...
	void FixedUpdate()
    {
        ...
        //Debug.Log("АшчГзвфеу = " + GameManager.Instance.GameState);
    ...
    {
        Debug.Log("IncreaseCurrentSpeed = " + GameManager.Instance.GameState);
